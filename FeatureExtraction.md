...
Note that this project will probably require quite a bit of mathematics (e.g. optimization) in addition to programming. So it could be a interesting choice if you enjoy wrestling with equations for hours. 
