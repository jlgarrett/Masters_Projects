...
=
Co-advised by [Manu Linares](https://manuelli.folk.ntnu.no/) from the Department of Physics

The NTNU Smallsat lab and the Department of Physics have started planning for a new satellite: the Gravitational wave Ultraviolet Transient SatellIte (GUTSI). 
We would like to use a moderately large (e.g. ~18cm aperture) telescope on the satellite. We also want to fit it on a small satellite, namely a 12-16U cubesat.
