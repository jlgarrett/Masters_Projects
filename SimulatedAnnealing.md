...
A few weeks ago, I was comparing a new unmixing technique against traditional methods, and I realized that an ancient numerical optimization method known as Simulated Annealing (SA) could minimize the unmixing objective function if a few constraints are applied.
